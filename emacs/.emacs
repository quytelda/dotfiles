...
;; yaml-mode
;; Use yaml-mode for Fedora CoreOS config files.
(add-to-list 'auto-mode-alist '("\\.fcc\\'" . yaml-mode))
...
;; material-theme
(when (ignore-errors (load-theme 'material t))
  (set-face-foreground 'line-number "#636D83")
  (set-face-foreground 'line-number-current-line "#ABB2BF"))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(markdown-mode rust-mode yaml-mode material-theme haskell-mode)))
(custom-set-faces
